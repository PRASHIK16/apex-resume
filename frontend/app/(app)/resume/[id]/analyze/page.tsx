...
const MOCK_ANALYSIS = {
  ...
  rejectionRisks: [
    ...
    },
    {
      ...
      severity: "HIGH" as const,
      fix: "Add metrics: 'Improved team velocity by 34%'",
    },
  ],
  bulletAnalyses: [
    {
      bulletId: "b1",
      original: "Worked on developing the payment infrastructure",
      confidenceScore: 22,
    ...
    {
      bulletId: "b2",
      original: "Led migration of monolith to microservices for 500K user product",
      confidenceScore: 91,
